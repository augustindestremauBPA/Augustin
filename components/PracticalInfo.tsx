...
const InfoItem: React.FC<{ icon: ReactNode; title: string; children: ReactNode }> = ({ icon, title, children }) => (
    <div className="flex items-start">
        ...
        <div>
            ...
            <div className="font-sans text-lg text-bpa-off-white font-semibold">{children}</div>
        </div>
    </div>
);
...
const UserIcon = () => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-bpa-gold" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" /></svg>;
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-on-scroll">
            ...
            <div className="space-y-6">
                ...
                <InfoItem icon={<LocationIcon />} title="Lieu">
                    Un lieu de qualité au coeur de Paris<br />
                    <span className="text-sm font-light opacity-80">(Adresse communiquée après inscription)</span>
                </InfoItem>
                <InfoItem icon={<UserIcon />} title="Profil">Cette formation est réservée aux fondateurs et dirigeants des organisations</InfoItem>
                <InfoItem icon={<PriceIcon />} title="Tarif">
                    1 300 € HT par participant<br />
                    <span className="text-sm font-light opacity-80">(Inclut échanges préalables, animation et supports)</span>
                </InfoItem>
            </div>
          </div>
          <div 
